// @shader drawTileFragmentFunc (Lithium)
// @0x000000000115e9 — Lithium.framework/Versions/A/Resources/LiSolidShaders.metallib
//
...
//
// Source LLVM IR: raw-port/re/shaders/drawTileFragmentFunc.ll (extracted by
// `bash raw-port/tools/shader_disasm.sh drawTileFragmentFunc Lithium`).
//
// AIR signature (from air.fragment metadata !15 and !18..!22):
//   define <4 x float> @drawTileFragmentFunc(
...
//
// AIR sampler state: @__air_sampler_state.1 = [i64 34901797601036873, i64 0].
...
//          texture %2, sampler bitcast(@__air_sampler_state.1),
...
/**
 * drawTileFragmentFunc — sample `tex` at `uv` and return the fp32 texel unchanged.
 *
 ...
 */
export function drawTileFragmentFunc(
