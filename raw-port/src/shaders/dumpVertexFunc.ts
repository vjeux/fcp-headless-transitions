// dumpVertexFunc.ts — trivial pass-through vertex shader.
// @shader dumpVertexFunc (Lithium)
// Source IR: raw-port/re/shaders/dumpVertexFunc.ll
// Compiled from: Lithium.framework/Versions/A/Resources/LiSolidShaders.metallib @0x0000000000007829
//
 ...
 */
export function dumpVertexFunc(
  position: [number, number],
  texCoord: [number, number],
): DumpVertexFuncOutput {
