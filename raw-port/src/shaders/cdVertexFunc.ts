// cdVertexFunc.ts — trivial pass-through vertex shader.
// @shader cdVertexFunc (Lithium)
// Source IR: raw-port/re/shaders/cdVertexFunc.ll
// Compiled from: Lithium.framework/Versions/A/Resources/LiSolidShaders.metallib @0x0000000000fdc9
//
// Byte-identical AIR IR to sibling ccVertexFunc — the two shaders differ only in the
// metallib entry offset and their name; the body (shufflevector + insertvalue pattern)
// is exactly the same. Kept as a distinct ONE-shader-per-file port per SHADERS.md.
//
