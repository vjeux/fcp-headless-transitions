// @shader blurVertexFunc (Lithium/LiSolidShaders) @0x00000000006c19
// Source IR: raw-port/re/shaders/blurVertexFunc.ll
...
// `0x00000000006c19 -- blurVertexFunc:` — the shader's entry offset in the metallib.
//
// Trivial fullscreen-quad passthrough vertex shader — the colour-blur sibling of
// `blurDepthVertexFunc`. Given a per-vertex 2D clip-space `position` and a 2D `texCoord`,
// emits:
 ...
 *
 * @IR entire function @0x00000000006c19.
 */
export function blurVertexFunc(
