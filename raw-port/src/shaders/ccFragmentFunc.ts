// @shader ccFragmentFunc (Lithium)
// @0x00000000017fa9 — Lithium.framework/Versions/A/Resources/LiSolidShaders.metallib
//
...
//
// Source LLVM IR: raw-port/re/shaders/ccFragmentFunc.ll (extracted by
// `bash raw-port/tools/shader_disasm.sh ccFragmentFunc Lithium`).
//
// AIR signature (from air.fragment metadata !15 and !18..!22):
//   define <4 x float> @ccFragmentFunc(
...
/**
 * ccFragmentFunc — sample `tex` at `uv` and return the fp32 texel unchanged.
 *
 ...
 */
export function ccFragmentFunc(
