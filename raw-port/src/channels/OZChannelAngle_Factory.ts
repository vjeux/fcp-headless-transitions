// OZChannelAngle_Factory — ProChannel factory singleton (partial port).
//
// This file ONLY transcribes ONE method today: the static `getInstance()`
// singleton accessor @ProChannel 0x190c. The rest of the factory (ctor,
...
//   000000000000190c	pushq	%rbp
//   000000000000190d	movq	%rsp, %rbp
//   0000000000001910	subq	$0x20, %rsp
//   0000000000001914	leaq	__ZN22OZChannelAngle_Factory13_instanceOnceE(%rip), %rax ## OZChannelAngle_Factory::_instanceOnce
//   000000000000191b	movq	(%rax), %rax
//   000000000000191e	cmpq	$-0x1, %rax
//   0000000000001922	je	0x1949
//   0000000000001924	leaq	-0x1(%rbp), %rax
//   0000000000001928	leaq	-0x18(%rbp), %rcx
//   000000000000192c	movq	%rax, (%rcx)
//   000000000000192f	leaq	-0x10(%rbp), %rsi
//   0000000000001933	movq	%rcx, (%rsi)
//   0000000000001936	leaq	__ZN22OZChannelAngle_Factory13_instanceOnceE(%rip), %rdi ## OZChannelAngle_Factory::_instanceOnce
//   000000000000193d	leaq	__ZNSt3__117__call_once_proxyB9nqe210106INS_5tupleIJOZN22OZChannelAngle_Factory11getInstanceEvEUlvE_EEEEEvPv(%rip), %rdx ## void std::__1::__call_once_proxy[abi:nqe210106]<std::__1::tuple<OZChannelAngle_Factory::getInstance()::'lambda'()&&>>(void*)
//   0000000000001944	callq	0xacdc8                         ## symbol stub for: __ZNSt3__111__call_onceERVmPvPFvS2_E
//   0000000000001949	leaq	__ZN22OZChannelAngle_Factory9_instanceE(%rip), %rax ## OZChannelAngle_Factory::_instance
//   0000000000001950	movq	(%rax), %rax
//   0000000000001953	addq	$0x20, %rsp
//   0000000000001957	popq	%rbp
//   0000000000001958	retq
//   0000000000001959	nop
//
// SEMANTIC SUMMARY
...
export class OZChannelAngle_Factory {
  /**
   * `OZChannelAngle_Factory::_instance` — program-global singleton pointer.
   * Loaded via RIP-relative at @0x1949. Initialized to null at
   * framework load; written exactly once by the __call_once thunk
   * (which is not part of THIS claim's function body).
   */
  private static _instance: OZChannelAngle_Factory | null = null;

  /**
   * `OZChannelAngle_Factory::_instanceOnce` — the `std::once_flag` (raw
   ...
   * Loaded via RIP-relative at @0x1914 and @0x1914.
   *
   ...
   *
   * Fast-path (@0x1914–0x191e): read `_instanceOnce` and short-
   * circuit to the tail load if it equals the libc++ "done" sentinel -1.
   *
   * Slow-path (through @0x1944): build the libc++ __call_once
   ...
   *
   * Tail (@0x1949–0x1958): load `_instance` and return it.
   */
  static getInstance(): OZChannelAngle_Factory | null {
    // @0x1914–read _instanceOnce.
    const flag = OZChannelAngle_Factory._instanceOnce.value;
    // @0x191e–@0x1922: `cmpq $-0x1, %rax ; je 0x1949`. libc++ "done" == -1.
    if (flag !== -1) {
