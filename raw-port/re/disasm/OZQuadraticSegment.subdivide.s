__ZN18OZQuadraticSegment9subdivideERS_S0_:
00000000004f0180	pushq	%rbp
00000000004f0181	movq	%rsp, %rbp
00000000004f0184	movq	0x4(%rdi), %rax
00000000004f0188	movq	%rax, %xmm0
00000000004f018d	movaps	0x22132c(%rip), %xmm1
00000000004f0194	mulps	%xmm1, %xmm0
00000000004f0197	movsd	0x14(%rdi), %xmm2
00000000004f019c	movaps	0x216c5d(%rip), %xmm3
00000000004f01a3	mulps	%xmm3, %xmm2
00000000004f01a6	addps	%xmm0, %xmm2
00000000004f01a9	movsd	0xc(%rdi), %xmm0
00000000004f01ae	movq	%rax, 0x4(%rsi)
00000000004f01b2	movddup	0x14(%rdi), %xmm4               ## xmm4 = mem[0,0]
00000000004f01b7	movddup	0x4(%rdi), %xmm5                ## xmm5 = mem[0,0]
00000000004f01bc	addps	%xmm4, %xmm5
00000000004f01bf	mulps	%xmm1, %xmm0
00000000004f01c2	blendps	$0xc, %xmm5, %xmm0              ## xmm0 = xmm0[0,1],xmm5[2,3]
00000000004f01c8	movaps	0x221301(%rip), %xmm1
00000000004f01cf	blendps	$0xc, %xmm1, %xmm2              ## xmm2 = xmm2[0,1],xmm1[2,3]
00000000004f01d5	addps	%xmm0, %xmm2
00000000004f01d8	mulps	%xmm1, %xmm5
00000000004f01db	blendps	$0x3, %xmm2, %xmm5              ## xmm5 = xmm2[0,1],xmm5[2,3]
00000000004f01e1	movups	%xmm5, 0xc(%rsi)
00000000004f01e5	movlps	%xmm2, 0x4(%rdx)
00000000004f01e9	movsd	0xc(%rdi), %xmm0
00000000004f01ee	movsd	0x14(%rdi), %xmm1
00000000004f01f3	addps	%xmm0, %xmm1
00000000004f01f6	mulps	%xmm3, %xmm1
00000000004f01f9	movlps	%xmm1, 0x14(%rdx)
00000000004f01fd	movq	0xc(%rdi), %rax
00000000004f0201	movq	%rax, 0xc(%rdx)
00000000004f0205	popq	%rbp
00000000004f0206	retq
00000000004f0207	addb	%al, (%rax)
00000000004f0209	addb	%al, (%rax)
00000000004f020b	addb	%al, (%rax)
00000000004f020d	addb	%al, (%rax)
