#!/usr/bin/env python3
"""Call OZChannelQuadPercent_Factory::revision() @ProChannel 0xa7788 in the LIVE Final Cut Pro
...
it is called by address at `_dyld_get_image_vmaddr_slide(ProChannel) + 0xa7788`, and the eight
...
VA = 0xa7788                                        # __ZN28OZChannelQuadPercent_Factory8revisionEv
...
controls = [
    ...
    ("M1 getIconIDInternal @0xa77fe (returns -1)", 0xa77fe, 1),
    ("M2 version @0xa777c (returns 1)", 0xa777c, 1),
    ("M3 getIconNameInternal @0xa77ce (PCString() into *%rdi)", 0xa77ce, 1),
]
ctl_bad = 0
