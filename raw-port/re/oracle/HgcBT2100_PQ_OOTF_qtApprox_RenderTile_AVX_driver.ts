// TS side of the differential oracle for HgcBT2100_PQ_OOTF_qtApprox::RenderTile_AVX @Helium 0x3a7220.
//
// Not part of the port (tsconfig only includes src/**). Driven by
// raw-port/re/oracle/HgcBT2100_PQ_OOTF_qtApprox_RenderTile_AVX_oracle.py, which builds the IDENTICAL tile
...
import {
  HgcBT2100_PQ_OOTF_qtApprox,
  type HGTile,
} from "../../src/render/HgcBT2100_PQ_OOTF_qtApprox.js";
...
process.stdin.on("end", () => {
  ...
  const out = cases.map((c) => {
    ...
    const node = new HgcBT2100_PQ_OOTF_qtApprox();
