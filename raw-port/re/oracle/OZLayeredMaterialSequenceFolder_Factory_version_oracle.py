...
weak claim for a 5-instruction body:
  ...
  1. BYTE SELF-CHECK — the 11 bytes at slide+0x281b0 must equal the encoding of
...
FW = "Ozone"
SYM = "__ZN39OZLayeredMaterialSequenceFolder_Factory7versionEv"

# The transcribed body, as encoded x86_64 bytes:
#   0x281b0  55              pushq %rbp
#   0x281b1  48 89 e5        movq  %rsp, %rbp
#   0x281b4  b8 01 00 00 00  movl  $0x1, %eax
#   0x281b9  5d              popq  %rbp
#   0x281ba  c3              retq
