...
[D1] @Ozone 0x6dc610.
    ...
    arch -x86_64 /usr/bin/python3 raw-port/re/oracle/OZTextLayout_Thn6720_D1_oracle.py
...
honest if the machine really does trap, so this harness proves it TWO ways:
  ...
  1. STATICALLY — the two bytes at slide + 0x6dc614 are read back through the
...
The sibling thunks (Thn200/216/240/18968 D1, and the Thn6720 D0) are checked
...
TARGET = ("__ZThn6720_N12OZTextLayoutD1Ev", 0x6DC610)
FAMILY = [
