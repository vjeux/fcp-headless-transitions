0x0000000006dc6d -- bm3dnr_buf::bm3dnr_buf_subsample2Image2D16b:
source_filename = "bm3dnr_buf::bm3dnr_buf_subsample2Image2D16b"
...
14:                                               ; preds = %9
  ...
  %36 = load <4 x i16>, <4 x i16> addrspace(1)* %35, align 8, !tbaa !37, !alias.scope !38, !noalias !39
  %37 = add nsw i32 %32, %31
  %38 = sext i32 %37 to i64
  %39 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %38
  %40 = load <4 x i16>, <4 x i16> addrspace(1)* %39, align 8, !tbaa !37, !alias.scope !38, !noalias !39
  %41 = shufflevector <4 x i16> %36, <4 x i16> %40, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %42 = mul nsw i32 %18, %10
  %43 = add nsw i32 %42, %5
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %3, i64 %44
  store <4 x i16> %41, <4 x i16> addrspace(1)* %45, align 8, !tbaa !37, !alias.scope !40, !noalias !41
  br label %46
...
!14 = !{void (%"struct.bm3dnr_buf::bm3dnr_buf_blend4x4Weight_params" addrspace(2)*, <2 x i32>, <4 x i16> addrspace(1)*, <4 x i16> addrspace(1)*)* @"bm3dnr_buf::bm3dnr_buf_subsample2Image2D16b", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20, !21}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 20, !"air.arg_type_align_size", i32 4, !"air.arg_type_name", !"bm3dnr_buf::bm3dnr_buf_subsample2Image2D16b_params", !"air.arg_name", !"params"}
...
!22 = !{!23, !24, i64 12}
!23 = !{!"_ZTSN10bm3dnr_buf38bm3dnr_buf_subsample2Image2D16b_paramsE", !24, i64 0, !24, i64 4, !24, i64 8, !24, i64 12, !24, i64 16}
!24 = !{!"int", !25, i64 0}
!25 = !{!"omnipotent char", !26, i64 0}
!26 = !{!"Simple C++ TBAA"}
!27 = !{!28}
!28 = distinct !{!28, !29, !"air-alias-scope-arg(0)"}
!29 = distinct !{!29, !"air-alias-scopes(bm3dnr_buf::bm3dnr_buf_subsample2Image2D16b)"}
!30 = !{!31, !32}
