0x0000000002e846 -- HitIDVertexFunc:
source_filename = "HitIDVertexFunc"
...
%struct.MDPHitIDVertex = type { <3 x float>, i32, [12 x i8] }

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define <{ <4 x float>, i32 }> @HitIDVertexFunc(%struct.MDPUniformMvp addrspace(2)* nocapture noundef readonly align 16 dereferenceable(64) "air-buffer-no-alias" %0, %struct.MDPHitIDVertex addrspace(1)* nocapture noundef readonly "air-buffer-no-alias" %1, i32 noundef %2) local_unnamed_addr #0 !dbg !39 {
  %4 = zext i32 %2 to i64, !dbg !42
  %5 = getelementptr inbounds %struct.MDPHitIDVertex, %struct.MDPHitIDVertex addrspace(1)* %1, i64 %4, i32 0, !dbg !43
  ...
  %24 = getelementptr inbounds %struct.MDPHitIDVertex, %struct.MDPHitIDVertex addrspace(1)* %1, i64 %4, i32 1, !dbg !85
  %25 = load i32, i32 addrspace(1)* %24, align 16, !dbg !85, !tbaa !86, !alias.scope !47, !noalias !50
  %26 = insertvalue <{ <4 x float>, i32 }> undef, <4 x float> %23, 0, !dbg !89
  %27 = insertvalue <{ <4 x float>, i32 }> %26, i32 %25, 1, !dbg !89
  ret <{ <4 x float>, i32 }> %27, !dbg !89
}
...
!29 = !{<{ <4 x float>, i32 }> (%struct.MDPUniformMvp addrspace(2)*, %struct.MDPHitIDVertex addrspace(1)*, i32)* @HitIDVertexFunc, !30, !33}
!30 = !{!31, !32}
!31 = !{!"air.position", !"air.arg_type_name", !"float4", !"air.arg_name", !"position"}
!32 = !{!"air.vertex_output", !"generated(5hitIDj)", !"air.arg_type_name", !"uint", !"air.arg_name", !"hitID"}
!33 = !{!34, !36, !38}
...
!36 = !{i32 1, !"air.buffer", !"air.location_index", i32 1, i32 1, !"air.read", !"air.address_space", i32 1, !"air.struct_type_info", !37, !"air.arg_type_size", i32 32, !"air.arg_type_align_size", i32 16, !"air.arg_type_name", !"MDPHitIDVertex", !"air.arg_name", !"verts"}
!37 = !{i32 0, i32 16, i32 0, !"float3", !"position", i32 16, i32 4, i32 0, !"uint", !"hitID"}
!38 = !{i32 2, !"air.vertex_id", !"air.arg_type_name", !"uint", !"air.arg_name", !"vert"}
!39 = distinct !DISubprogram(name: "HitIDVertexFunc", scope: !8, file: !8, line: 26, type: !40, scopeLine: 29, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !41)
!40 = !DISubroutineType(types: !41)
!41 = !{}
!42 = !DILocation(line: 31, column: 25, scope: !39)
!43 = !DILocation(line: 31, column: 37, scope: !39)
!44 = !{!45, !45, i64 0}
!45 = !{!"omnipotent char", !46, i64 0}
!46 = !{!"Simple C++ TBAA"}
!47 = !{!48}
!48 = distinct !{!48, !49, !"air-alias-scope-arg(1)"}
!49 = distinct !{!49, !"air-alias-scopes(HitIDVertexFunc)"}
!50 = !{!51}
...
!59 = distinct !DILocation(line: 32, column: 33, scope: !39)
...
!85 = !DILocation(line: 33, column: 29, scope: !39)
!86 = !{!87, !88, i64 16}
!87 = !{!"_ZTS14MDPHitIDVertex", !45, i64 0, !88, i64 16}
!88 = !{!"int", !45, i64 0}
!89 = !DILocation(line: 35, column: 1, scope: !39)
