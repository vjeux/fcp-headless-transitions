0x0000000000ca90 -- histogram_vertex_shader:
source_filename = "histogram_vertex_shader"
...
define <{ <4 x float>, <4 x float>, <2 x float>, float }> @histogram_vertex_shader(i32 noundef %0, %"struct.metal::_atomic" addrspace(1)* nocapture noundef "air-buffer-no-alias" %1, %struct.histogram_state_t addrspace(2)* nocapture noundef readonly "air-buffer-no-alias" %2) local_unnamed_addr #1 {
  ...
  %15 = getelementptr inbounds %struct.histogram_state_t, %struct.histogram_state_t addrspace(2)* %2, i64 0, i32 2
  %16 = load <4 x float>, <4 x float> addrspace(2)* %15, align 16, !tbaa !32, !alias.scope !33, !noalias !36
  %17 = getelementptr inbounds %struct.histogram_state_t, %struct.histogram_state_t addrspace(2)* %2, i64 0, i32 6
  %18 = load float, float addrspace(2)* %17, align 4, !tbaa !38, !alias.scope !33, !noalias !36
  %19 = tail call fast float @air.fast_clamp.f32(float %18, float 0.000000e+00, float 1.000000e+00) #5
  %20 = fmul fast float %19, 2.000000e+00
  %21 = fsub fast float 3.000000e+00, %20
  %22 = fmul fast float %19, %19
  %23 = fmul fast float %22, 0x3FCB020C40000000
  %24 = fmul fast float %23, %21
  %25 = fadd fast float %24, 0x3FCD916880000000
  %26 = insertelement <4 x float> %16, float %25, i64 3
  %27 = insertvalue <{ <4 x float>, <4 x float>, <2 x float>, float }> undef, <4 x float> %12, 0
  %28 = insertvalue <{ <4 x float>, <4 x float>, <2 x float>, float }> %27, <4 x float> %26, 1
  %29 = insertvalue <{ <4 x float>, <4 x float>, <2 x float>, float }> %28, <2 x float> %13, 2
  %30 = insertvalue <{ <4 x float>, <4 x float>, <2 x float>, float }> %29, float %14, 3
  ret <{ <4 x float>, <4 x float>, <2 x float>, float }> %30
}
...
9:                                                ; preds = %4
  ...
  %15 = load i32, i32 addrspace(2)* %14, align 4, !tbaa !44
  %16 = add i32 %15, %13
  ...
  %22 = load float, float addrspace(2)* %21, align 8, !tbaa !45
...
27:                                               ; preds = %9, %7
  ...
  %30 = load <4 x float>, <4 x float> addrspace(2)* %29, align 16, !tbaa !32
  ...
  %34 = load <4 x float>, <4 x float> addrspace(2)* %33, align 16, !tbaa !32
  ...
  %38 = load <4 x float>, <4 x float> addrspace(2)* %37, align 16, !tbaa !32
  ...
  %42 = load <4 x float>, <4 x float> addrspace(2)* %41, align 16, !tbaa !32
...
!15 = !{<{ <4 x float>, <4 x float>, <2 x float>, float }> (i32, %"struct.metal::_atomic" addrspace(1)*, %struct.histogram_state_t addrspace(2)*)* @histogram_vertex_shader, !16, !21}
!16 = !{!17, !18, !19, !20}
...
!32 = !{!30, !30, i64 0}
!33 = !{!34}
!34 = distinct !{!34, !35, !"air-alias-scope-arg(2)"}
!35 = distinct !{!35, !"air-alias-scopes(histogram_vertex_shader)"}
!36 = !{!37}
!37 = distinct !{!37, !35, !"air-alias-scope-arg(1)"}
!38 = !{!39, !43, i64 140}
!39 = !{!"_ZTS17histogram_state_t", !40, i64 0, !41, i64 64, !30, i64 112, !42, i64 128, !29, i64 132, !43, i64 136, !43, i64 140}
!40 = !{!"_ZTSN5metal6matrixIfLi4ELi4EvEE", !30, i64 0}
!41 = !{!"_ZTSN5metal6matrixIfLi3ELi3EvEE", !30, i64 0}
!42 = !{!"_ZTS23histogram_computation_t", !30, i64 0}
!43 = !{!"float", !30, i64 0}
!44 = !{!39, !29, i64 132}
!45 = !{!39, !43, i64 136}
