0x0000000001546d -- bm3dnr_buf::bm3dnr_buf_blend8x8Weight16:
source_filename = "bm3dnr_buf::bm3dnr_buf_blend8x8Weight16"
...
74:                                               ; preds = %74, %51
  ...
  %87 = tail call <4 x float> @air.floor.v4f32(<4 x float> %86) #1
  %88 = tail call <4 x float> @air.clamp.v4f32(<4 x float> %87, <4 x float> <float -3.276800e+04, float -3.276800e+04, float -3.276800e+04, float -3.276800e+04>, <4 x float> <float 3.276700e+04, float 3.276700e+04, float 3.276700e+04, float 3.276700e+04>) #1
  %89 = tail call <4 x i16> @air.convert.s.v4i16.f.v4f32(<4 x float> %88) #1
  %90 = add nuw nsw i64 %29, %76
  %91 = mul i64 %90, %52
  %92 = add i64 %91, %28
  %93 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %92
  store <4 x i16> %89, <4 x i16> addrspace(1)* %93, align 8, !tbaa !39, !alias.scope !46, !noalias !47
  %94 = getelementptr inbounds [16 x <4 x float>], [16 x <4 x float>]* %6, i64 0, i64 %80
  %95 = load <4 x float>, <4 x float>* %94, align 16, !tbaa !39
  %96 = fmul <4 x float> %82, %95
  %97 = fadd <4 x float> %96, <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  %98 = tail call <4 x float> @air.floor.v4f32(<4 x float> %97) #1
  %99 = tail call <4 x float> @air.clamp.v4f32(<4 x float> %98, <4 x float> <float -3.276800e+04, float -3.276800e+04, float -3.276800e+04, float -3.276800e+04>, <4 x float> <float 3.276700e+04, float 3.276700e+04, float 3.276700e+04, float 3.276700e+04>) #1
  %100 = tail call <4 x i16> @air.convert.s.v4i16.f.v4f32(<4 x float> %99) #1
  %101 = add i64 %53, %91
  %102 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %101
  store <4 x i16> %100, <4 x i16> addrspace(1)* %102, align 8, !tbaa !39, !alias.scope !46, !noalias !47
  %103 = add nuw nsw i32 %75, 1
  %104 = icmp eq i32 %103, 8
  br i1 %104, label %73, label %74, !llvm.loop !48
...
!14 = !{void (%"struct.bm3dnr_buf::bm3dnr_buf_blend4x4Weight_params" addrspace(2)*, <2 x i32>, <4 x i16> addrspace(1)*, <4 x float> addrspace(1)*, <4 x float> addrspace(1)*)* @"bm3dnr_buf::bm3dnr_buf_blend8x8Weight16", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20, !21, !22}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 20, !"air.arg_type_align_size", i32 4, !"air.arg_type_name", !"bm3dnr_buf::bm3dnr_buf_blend8x8Weight16_params", !"air.arg_name", !"params"}
...
!23 = !{!24, !25, i64 12}
!24 = !{!"_ZTSN10bm3dnr_buf34bm3dnr_buf_blend8x8Weight16_paramsE", !25, i64 0, !25, i64 4, !25, i64 8, !25, i64 12, !25, i64 16}
!25 = !{!"int", !26, i64 0}
!26 = !{!"omnipotent char", !27, i64 0}
!27 = !{!"Simple C++ TBAA"}
!28 = !{!29}
!29 = distinct !{!29, !30, !"air-alias-scope-arg(0)"}
!30 = distinct !{!30, !"air-alias-scopes(bm3dnr_buf::bm3dnr_buf_blend8x8Weight16)"}
!31 = !{!32, !33, !34}
