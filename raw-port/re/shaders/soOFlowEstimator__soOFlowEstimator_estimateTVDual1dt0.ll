0x000000000b9dbd -- soOFlowEstimator::soOFlowEstimator_estimateTVDual1dt0:
source_filename = "soOFlowEstimator::soOFlowEstimator_estimateTVDual1dt0"
...
!14 = !{void (%"struct.soOFlowEstimator::soOFlowEstimator_estimateTVDual1dt0_params" addrspace(2)*, <2 x i32>, %struct._sampler_t addrspace(2)*, %struct._texture_2d_t addrspace(1)*, %struct._texture_2d_t addrspace(1)*, %struct._texture_2d_t addrspace(1)*, %struct._texture_2d_t addrspace(1)*, %struct._texture_2d_t addrspace(1)*, %struct._texture_2d_t addrspace(1)*, %struct._texture_2d_t addrspace(1)*)* @"soOFlowEstimator::soOFlowEstimator_estimateTVDual1dt0", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20, !21, !22, !23, !24, !25, !26, !27}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 20, !"air.arg_type_align_size", i32 4, !"air.arg_type_name", !"soOFlowEstimator::soOFlowEstimator_estimateTVDual1dt0_params", !"air.arg_name", !"params"}
...
!23 = !{i32 5, !"air.texture", !"air.location_index", i32 2, i32 1, !"air.sample", !"air.arg_type_name", !"texture2d<float, sample>", !"air.arg_name", !"I2_flowWarpedGrad_"}
...
!28 = !{!29, !33, i64 12}
!29 = !{!"_ZTSN16soOFlowEstimator42soOFlowEstimator_estimateTVDual1dt0_paramsE", !30, i64 0, !30, i64 4, !30, i64 8, !33, i64 12, !33, i64 16}
!30 = !{!"float", !31, i64 0}
...
!36 = distinct !{!36, !"air-alias-scopes(soOFlowEstimator::soOFlowEstimator_estimateTVDual1dt0)"}
!37 = !{!38, !39}
