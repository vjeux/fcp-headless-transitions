0x00000000018f9d -- bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16:
source_filename = "bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16"
...
define void @"bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16"(%"struct.bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16_params" addrspace(2)* nocapture readonly "air-buffer-no-alias" %0, <2 x i32> %1, <4 x i16> addrspace(1)* nocapture readonly "air-buffer-no-alias" %2, <4 x i16> addrspace(1)* nocapture "air-buffer-no-alias" %3) local_unnamed_addr #0 {
...
14:                                               ; preds = %9
  ...
  %44 = tail call <4 x float> @air.convert.f.v4f32.s.v4i16(<4 x i16> %43) #1
  %45 = add nsw i32 %39, %5
  ...
  %49 = tail call <4 x float> @air.convert.f.v4f32.s.v4i16(<4 x i16> %48) #1
  ...
  %54 = tail call <4 x float> @air.convert.f.v4f32.s.v4i16(<4 x i16> %53) #1
  ...
  %65 = tail call <4 x float> @air.convert.f.v4f32.s.v4i16(<4 x i16> %64) #1
  ...
  %70 = tail call <4 x float> @air.convert.f.v4f32.s.v4i16(<4 x i16> %69) #1
  ...
  %81 = tail call <4 x float> @air.convert.f.v4f32.s.v4i16(<4 x i16> %80) #1
  ...
  %86 = tail call <4 x float> @air.convert.f.v4f32.s.v4i16(<4 x i16> %85) #1
  ...
  %154 = tail call <4 x float> @air.floor.v4f32(<4 x float> %153) #1
  %155 = tail call <4 x float> @air.clamp.v4f32(<4 x float> %154, <4 x float> <float -3.276800e+04, float -3.276800e+04, float -3.276800e+04, float -3.276800e+04>, <4 x float> <float 3.276700e+04, float 3.276700e+04, float 3.276700e+04, float 3.276700e+04>) #1
  %156 = tail call <4 x i16> @air.convert.s.v4i16.f.v4f32(<4 x float> %155) #1
  %157 = mul nsw i32 %22, %10
  %158 = add nsw i32 %157, %5
  %159 = sext i32 %158 to i64
  %160 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %3, i64 %159
  store <4 x i16> %156, <4 x i16> addrspace(1)* %160, align 8, !tbaa !40, !alias.scope !43, !noalias !44
  br label %161
...
!14 = !{void (%"struct.bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16_params" addrspace(2)*, <2 x i32>, <4 x i16> addrspace(1)*, <4 x i16> addrspace(1)*)* @"bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20, !21}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 28, !"air.arg_type_align_size", i32 4, !"air.arg_type_name", !"bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16_params", !"air.arg_name", !"params"}
...
!22 = !{!23, !24, i64 20}
!23 = !{!"_ZTSN10bm3dnr_buf34bm3dnr_buf_blf2DImage3x3S16_paramsE", !24, i64 0, !24, i64 4, !24, i64 8, !24, i64 12, !27, i64 16, !24, i64 20, !24, i64 24}
!24 = !{!"int", !25, i64 0}
...
!30 = distinct !{!30, !"air-alias-scopes(bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16)"}
!31 = !{!32, !33}
