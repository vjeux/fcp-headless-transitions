0x00000000022706 -- TextureVertexFunc:
source_filename = "TextureVertexFunc"
...
define <{ <4 x float>, <4 x float>, <2 x float> }> @TextureVertexFunc(%struct.MDPUniformMvp addrspace(2)* nocapture noundef readonly align 16 dereferenceable(64) "air-buffer-no-alias" %0, %struct.MDPTextureVertex addrspace(1)* nocapture noundef readonly "air-buffer-no-alias" %1, i32 noundef %2) local_unnamed_addr #0 !dbg !40 {
...
!29 = !{<{ <4 x float>, <4 x float>, <2 x float> }> (%struct.MDPUniformMvp addrspace(2)*, %struct.MDPTextureVertex addrspace(1)*, i32)* @TextureVertexFunc, !30, !34}
!30 = !{!31, !32, !33}
...
!40 = distinct !DISubprogram(name: "TextureVertexFunc", scope: !8, file: !8, line: 28, type: !41, scopeLine: 31, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !42)
...
!50 = distinct !{!50, !"air-alias-scopes(TextureVertexFunc)"}
!51 = !{!52}
