0x00000000024fad -- bm3dnr_buf::bm3dnr_buf_filterImage2DTriPlane16b:
source_filename = "bm3dnr_buf::bm3dnr_buf_filterImage2DTriPlane16b"
...
14:                                               ; preds = %9
  ...
  %47 = load <4 x i16>, <4 x i16> addrspace(1)* %46, align 8, !tbaa !38, !alias.scope !39, !noalias !40
  %48 = add i32 %34, %39
  %49 = zext i32 %48 to i64
  %50 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %49
  %51 = load <4 x i16>, <4 x i16> addrspace(1)* %50, align 8, !tbaa !38, !alias.scope !39, !noalias !40
  %52 = sext i32 %27 to i64
  %53 = zext i32 %16 to i64
  %54 = mul nuw i64 %53, %24
  %55 = add i64 %54, %52
  %56 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %55
  %57 = load <4 x i16>, <4 x i16> addrspace(1)* %56, align 8, !tbaa !38, !alias.scope !39, !noalias !40
  ...
  %72 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %71
  %73 = load <4 x i16>, <4 x i16> addrspace(1)* %72, align 8, !tbaa !38, !alias.scope !39, !noalias !40
  %74 = add i32 %65, %34
  %75 = zext i32 %74 to i64
  %76 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %75
  %77 = load <4 x i16>, <4 x i16> addrspace(1)* %76, align 8, !tbaa !38, !alias.scope !39, !noalias !40
  %78 = shufflevector <4 x i16> %43, <4 x i16> undef, <4 x i32> <i32 3, i32 undef, i32 undef, i32 undef>
  %79 = shufflevector <4 x i16> %78, <4 x i16> %47, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  %80 = shufflevector <4 x i16> %57, <4 x i16> undef, <4 x i32> <i32 3, i32 undef, i32 undef, i32 undef>
  %81 = shufflevector <4 x i16> %80, <4 x i16> %60, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  %82 = shufflevector <4 x i16> %69, <4 x i16> undef, <4 x i32> <i32 3, i32 undef, i32 undef, i32 undef>
  %83 = shufflevector <4 x i16> %82, <4 x i16> %73, <4 x i32> <i32 0, i32 4, i32 5, i32 6>
  %84 = shufflevector <4 x i16> %47, <4 x i16> undef, <3 x i32> <i32 1, i32 2, i32 3>
  %85 = shufflevector <3 x i16> %84, <3 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
  %86 = shufflevector <4 x i16> %85, <4 x i16> %51, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %87 = shufflevector <4 x i16> %60, <4 x i16> undef, <3 x i32> <i32 1, i32 2, i32 3>
  %88 = shufflevector <3 x i16> %87, <3 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
  %89 = shufflevector <4 x i16> %88, <4 x i16> %64, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %90 = shufflevector <4 x i16> %73, <4 x i16> undef, <3 x i32> <i32 1, i32 2, i32 3>
  %91 = shufflevector <3 x i16> %90, <3 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
  %92 = shufflevector <4 x i16> %91, <4 x i16> %77, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %93 = tail call <4 x float> @air.convert.f.v4f32.u.v4i16(<4 x i16> %79) #1
  %94 = tail call <4 x float> @air.convert.f.v4f32.u.v4i16(<4 x i16> %83) #1
  %95 = fadd <4 x float> %93, %94
  %96 = tail call <4 x float> @air.convert.f.v4f32.u.v4i16(<4 x i16> %47) #1
  %97 = tail call <4 x float> @air.convert.f.v4f32.u.v4i16(<4 x i16> %73) #1
  %98 = fadd <4 x float> %96, %97
  %99 = tail call <4 x float> @air.convert.f.v4f32.u.v4i16(<4 x i16> %86) #1
  %100 = tail call <4 x float> @air.convert.f.v4f32.u.v4i16(<4 x i16> %92) #1
  %101 = fadd <4 x float> %99, %100
  %102 = tail call <4 x float> @air.convert.f.v4f32.u.v4i16(<4 x i16> %81) #1
  %103 = tail call <4 x float> @air.convert.f.v4f32.u.v4i16(<4 x i16> %60) #1
  %104 = tail call <4 x float> @air.convert.f.v4f32.u.v4i16(<4 x i16> %89) #1
  ...
  %113 = tail call <4 x float> @air.clamp.v4f32(<4 x float> %112, <4 x float> zeroinitializer, <4 x float> <float 6.553500e+04, float 6.553500e+04, float 6.553500e+04, float 6.553500e+04>) #1
  %114 = tail call <4 x i16> @air.convert.u.v4i16.f.v4f32(<4 x float> %113) #1
  %115 = zext i32 %18 to i64
  %116 = mul nuw i64 %115, %24
  %117 = add nuw i64 %116, %23
  %118 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %3, i64 %117
  store <4 x i16> %114, <4 x i16> addrspace(1)* %118, align 8, !tbaa !38, !alias.scope !41, !noalias !42
  br label %119
...
!14 = !{void (%"struct.bm3dnr_buf::bm3dnr_buf_blend4x4Column_params" addrspace(2)*, <2 x i32>, <4 x i16> addrspace(1)*, <4 x i16> addrspace(1)*)* @"bm3dnr_buf::bm3dnr_buf_filterImage2DTriPlane16b", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20, !21}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 24, !"air.arg_type_align_size", i32 4, !"air.arg_type_name", !"bm3dnr_buf::bm3dnr_buf_filterImage2DTriPlane16b_params", !"air.arg_name", !"params"}
...
!22 = !{!23, !24, i64 16}
!23 = !{!"_ZTSN10bm3dnr_buf42bm3dnr_buf_filterImage2DTriPlane16b_paramsE", !24, i64 0, !24, i64 4, !24, i64 8, !24, i64 12, !24, i64 16, !24, i64 20}
!24 = !{!"int", !25, i64 0}
!25 = !{!"omnipotent char", !26, i64 0}
!26 = !{!"Simple C++ TBAA"}
!27 = !{!28}
!28 = distinct !{!28, !29, !"air-alias-scope-arg(0)"}
!29 = distinct !{!29, !"air-alias-scopes(bm3dnr_buf::bm3dnr_buf_filterImage2DTriPlane16b)"}
!30 = !{!31, !32}
