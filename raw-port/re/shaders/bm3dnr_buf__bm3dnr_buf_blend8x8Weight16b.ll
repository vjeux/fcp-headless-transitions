0x0000000001686d -- bm3dnr_buf::bm3dnr_buf_blend8x8Weight16b:
source_filename = "bm3dnr_buf::bm3dnr_buf_blend8x8Weight16b"
...
74:                                               ; preds = %74, %51
  ...
  %87 = tail call <4 x float> @air.clamp.v4f32(<4 x float> %86, <4 x float> zeroinitializer, <4 x float> <float 6.553500e+04, float 6.553500e+04, float 6.553500e+04, float 6.553500e+04>) #1
  %88 = tail call <4 x i16> @air.convert.u.v4i16.f.v4f32(<4 x float> %87) #1
  %89 = add nuw nsw i64 %29, %76
  %90 = mul i64 %89, %52
  %91 = add i64 %90, %28
  %92 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %91
  store <4 x i16> %88, <4 x i16> addrspace(1)* %92, align 8, !tbaa !39, !alias.scope !46, !noalias !47
  ...
  %97 = tail call <4 x float> @air.clamp.v4f32(<4 x float> %96, <4 x float> zeroinitializer, <4 x float> <float 6.553500e+04, float 6.553500e+04, float 6.553500e+04, float 6.553500e+04>) #1
  %98 = tail call <4 x i16> @air.convert.u.v4i16.f.v4f32(<4 x float> %97) #1
  %99 = add i64 %53, %90
  %100 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %99
  store <4 x i16> %98, <4 x i16> addrspace(1)* %100, align 8, !tbaa !39, !alias.scope !46, !noalias !47
...
!14 = !{void (%"struct.bm3dnr_buf::bm3dnr_buf_blend4x4Weight_params" addrspace(2)*, <2 x i32>, <4 x i16> addrspace(1)*, <4 x float> addrspace(1)*, <4 x float> addrspace(1)*)* @"bm3dnr_buf::bm3dnr_buf_blend8x8Weight16b", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20, !21, !22}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 20, !"air.arg_type_align_size", i32 4, !"air.arg_type_name", !"bm3dnr_buf::bm3dnr_buf_blend8x8Weight16b_params", !"air.arg_name", !"params"}
...
!20 = !{i32 2, !"air.buffer", !"air.location_index", i32 1, i32 1, !"air.read_write", !"air.arg_type_size", i32 8, !"air.arg_type_align_size", i32 8, !"air.arg_type_name", !"ushort4", !"air.arg_name", !"output"}
...
!23 = !{!24, !25, i64 12}
!24 = !{!"_ZTSN10bm3dnr_buf35bm3dnr_buf_blend8x8Weight16b_paramsE", !25, i64 0, !25, i64 4, !25, i64 8, !25, i64 12, !25, i64 16}
!25 = !{!"int", !26, i64 0}
!26 = !{!"omnipotent char", !27, i64 0}
!27 = !{!"Simple C++ TBAA"}
!28 = !{!29}
!29 = distinct !{!29, !30, !"air-alias-scope-arg(0)"}
!30 = distinct !{!30, !"air-alias-scopes(bm3dnr_buf::bm3dnr_buf_blend8x8Weight16b)"}
!31 = !{!32, !33, !34}
