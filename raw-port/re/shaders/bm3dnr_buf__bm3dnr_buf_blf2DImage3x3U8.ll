0x0000000001b98d -- bm3dnr_buf::bm3dnr_buf_blf2DImage3x3U8:
source_filename = "bm3dnr_buf::bm3dnr_buf_blf2DImage3x3U8"
...
define void @"bm3dnr_buf::bm3dnr_buf_blf2DImage3x3U8"(%"struct.bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16_params" addrspace(2)* nocapture readonly "air-buffer-no-alias" %0, <2 x i32> %1, <4 x i8> addrspace(1)* nocapture readonly "air-buffer-no-alias" %2, <4 x i8> addrspace(1)* nocapture "air-buffer-no-alias" %3) local_unnamed_addr #0 {
...
14:                                               ; preds = %9
  ...
  %43 = load <4 x i8>, <4 x i8> addrspace(1)* %42, align 4, !tbaa !40, !alias.scope !41, !noalias !42
  %44 = tail call <4 x float> @air.convert.f.v4f32.u.v4i8(<4 x i8> %43) #1
  %45 = add nsw i32 %39, %5
  %46 = sext i32 %45 to i64
  %47 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %46
  %48 = load <4 x i8>, <4 x i8> addrspace(1)* %47, align 4, !tbaa !40, !alias.scope !41, !noalias !42
  %49 = tail call <4 x float> @air.convert.f.v4f32.u.v4i8(<4 x i8> %48) #1
  %50 = add nsw i32 %39, %33
  %51 = sext i32 %50 to i64
  %52 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %51
  %53 = load <4 x i8>, <4 x i8> addrspace(1)* %52, align 4, !tbaa !40, !alias.scope !41, !noalias !42
  %54 = tail call <4 x float> @air.convert.f.v4f32.u.v4i8(<4 x i8> %53) #1
  %55 = mul nsw i32 %20, %10
  %56 = add nsw i32 %55, %30
  %57 = sext i32 %56 to i64
  %58 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %57
  %59 = load <4 x i8>, <4 x i8> addrspace(1)* %58, align 4, !tbaa !40, !alias.scope !41, !noalias !42
  %60 = tail call <4 x float> @air.convert.f.v4f32.u.v4i8(<4 x i8> %59) #1
  %61 = add nsw i32 %55, %5
  %62 = sext i32 %61 to i64
  %63 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %62
  %64 = load <4 x i8>, <4 x i8> addrspace(1)* %63, align 4, !tbaa !40, !alias.scope !41, !noalias !42
  %65 = tail call <4 x float> @air.convert.f.v4f32.u.v4i8(<4 x i8> %64) #1
  %66 = add nsw i32 %55, %33
  %67 = sext i32 %66 to i64
  %68 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %67
  %69 = load <4 x i8>, <4 x i8> addrspace(1)* %68, align 4, !tbaa !40, !alias.scope !41, !noalias !42
  %70 = tail call <4 x float> @air.convert.f.v4f32.u.v4i8(<4 x i8> %69) #1
  %71 = mul nsw i32 %38, %20
  %72 = add nsw i32 %71, %30
  %73 = sext i32 %72 to i64
  %74 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %73
  %75 = load <4 x i8>, <4 x i8> addrspace(1)* %74, align 4, !tbaa !40, !alias.scope !41, !noalias !42
  %76 = tail call <4 x float> @air.convert.f.v4f32.u.v4i8(<4 x i8> %75) #1
  %77 = add nsw i32 %71, %5
  %78 = sext i32 %77 to i64
  %79 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %78
  %80 = load <4 x i8>, <4 x i8> addrspace(1)* %79, align 4, !tbaa !40, !alias.scope !41, !noalias !42
  %81 = tail call <4 x float> @air.convert.f.v4f32.u.v4i8(<4 x i8> %80) #1
  %82 = add nsw i32 %71, %33
  %83 = sext i32 %82 to i64
  %84 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %83
  %85 = load <4 x i8>, <4 x i8> addrspace(1)* %84, align 4, !tbaa !40, !alias.scope !41, !noalias !42
  %86 = tail call <4 x float> @air.convert.f.v4f32.u.v4i8(<4 x i8> %85) #1
  ...
  %154 = tail call <4 x float> @air.clamp.v4f32(<4 x float> %153, <4 x float> zeroinitializer, <4 x float> <float 2.550000e+02, float 2.550000e+02, float 2.550000e+02, float 2.550000e+02>) #1
  %155 = tail call <4 x i8> @air.convert.u.v4i8.f.v4f32(<4 x float> %154) #1
  %156 = mul nsw i32 %22, %10
  %157 = add nsw i32 %156, %5
  %158 = sext i32 %157 to i64
  %159 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %3, i64 %158
  store <4 x i8> %155, <4 x i8> addrspace(1)* %159, align 4, !tbaa !40, !alias.scope !43, !noalias !44
  br label %160
...
!14 = !{void (%"struct.bm3dnr_buf::bm3dnr_buf_blf2DImage3x3S16_params" addrspace(2)*, <2 x i32>, <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*)* @"bm3dnr_buf::bm3dnr_buf_blf2DImage3x3U8", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20, !21}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 28, !"air.arg_type_align_size", i32 4, !"air.arg_type_name", !"bm3dnr_buf::bm3dnr_buf_blf2DImage3x3U8_params", !"air.arg_name", !"params"}
...
!22 = !{!23, !24, i64 20}
!23 = !{!"_ZTSN10bm3dnr_buf33bm3dnr_buf_blf2DImage3x3U8_paramsE", !24, i64 0, !24, i64 4, !24, i64 8, !24, i64 12, !27, i64 16, !24, i64 20, !24, i64 24}
!24 = !{!"int", !25, i64 0}
...
!30 = distinct !{!30, !"air-alias-scopes(bm3dnr_buf::bm3dnr_buf_blf2DImage3x3U8)"}
!31 = !{!32, !33}
