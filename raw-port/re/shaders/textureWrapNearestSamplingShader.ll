0x00000000016510 -- textureWrapNearestSamplingShader:
source_filename = "textureWrapNearestSamplingShader"
...
@__air_sampler_state.2 = internal addrspace(2) constant [2 x i64] [i64 34901797601018002, i64 0], align 8
@llvm.global_ctors = appending global [0 x { i32, void ()*, i8* }] zeroinitializer

; Function Attrs: argmemonly convergent mustprogress nofree nounwind readonly willreturn
define <4 x float> @textureWrapNearestSamplingShader(<4 x float> %0, <2 x float> %1, %struct._texture_2d_t addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
  %4 = tail call { <4 x half>, i8 } @air.sample_texture_2d.v4f16(%struct._texture_2d_t addrspace(1)* nocapture readonly %2, %struct._sampler_t addrspace(2)* nocapture readonly bitcast ([2 x i64] addrspace(2)* @__air_sampler_state.2 to %struct._sampler_t addrspace(2)*), <2 x float> %1, i1 true, <2 x i32> zeroinitializer, i1 false, float 0.000000e+00, float 0.000000e+00, i32 0) #3
  %5 = extractvalue { <4 x half>, i8 } %4, 0
  %6 = tail call fast <4 x float> @air.convert.f.v4f32.f.v4f16(<4 x half> %5) #4
  ret <4 x float> %6
}
...
!15 = !{<4 x float> (<4 x float>, <2 x float>, %struct._texture_2d_t addrspace(1)*)* @textureWrapNearestSamplingShader, !16, !18}
!16 = !{!17}
...
!22 = !{!"air.sampler_state", [2 x i64] addrspace(2)* @__air_sampler_state.2}
