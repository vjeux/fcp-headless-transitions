0x00000000069e2d -- bm3dnr_buf::bm3dnr_buf_replicateBottom16b:
source_filename = "bm3dnr_buf::bm3dnr_buf_replicateBottom16b"
...
define void @"bm3dnr_buf::bm3dnr_buf_replicateBottom16b"(%"struct.bm3dnr_buf::bm3dnr_buf_blend4x4Weight_params" addrspace(2)* nocapture readonly "air-buffer-no-alias" %0, <2 x i32> %1, <4 x i16> addrspace(1)* nocapture "air-buffer-no-alias" %2) local_unnamed_addr #0 {
...
13:                                               ; preds = %8
  ...
  %25 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %24
  %26 = load <4 x i16>, <4 x i16> addrspace(1)* %25, align 8, !tbaa !35, !alias.scope !29, !noalias !26
  %27 = sub i32 %19, %17
  %28 = icmp sgt i32 %27, 0
  br i1 %28, label %29, label %38

29:                                               ; preds = %29, %13
  %30 = phi i32 [ %36, %29 ], [ 0, %13 ]
  %31 = add nsw i32 %30, %17
  %32 = mul nsw i32 %31, %15
  %33 = sext i32 %32 to i64
  %34 = add nsw i64 %33, %20
  %35 = getelementptr inbounds <4 x i16>, <4 x i16> addrspace(1)* %2, i64 %34
  store <4 x i16> %26, <4 x i16> addrspace(1)* %35, align 8, !tbaa !35, !alias.scope !29, !noalias !26
  %36 = add nuw nsw i32 %30, 1
  %37 = icmp eq i32 %36, %27
  br i1 %37, label %38, label %29, !llvm.loop !36
...
!14 = !{void (%"struct.bm3dnr_buf::bm3dnr_buf_blend4x4Weight_params" addrspace(2)*, <2 x i32>, <4 x i16> addrspace(1)*)* @"bm3dnr_buf::bm3dnr_buf_replicateBottom16b", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 20, !"air.arg_type_align_size", i32 4, !"air.arg_type_name", !"bm3dnr_buf::bm3dnr_buf_replicateBottom16b_params", !"air.arg_name", !"params"}
!18 = !{i32 0, i32 4, i32 0, !"int", !"m_stride", i32 4, i32 4, i32 0, !"int", !"m_height", i32 8, i32 4, i32 0, !"int", !"m_heightOut", i32 12, i32 4, i32 0, !"uint", !"m_globalWidth", i32 16, i32 4, i32 0, !"uint", !"m_globalHeight"}
...
!21 = !{!22, !23, i64 12}
!22 = !{!"_ZTSN10bm3dnr_buf36bm3dnr_buf_replicateBottom16b_paramsE", !23, i64 0, !23, i64 4, !23, i64 8, !23, i64 12, !23, i64 16}
!23 = !{!"int", !24, i64 0}
!24 = !{!"omnipotent char", !25, i64 0}
!25 = !{!"Simple C++ TBAA"}
!26 = !{!27}
!27 = distinct !{!27, !28, !"air-alias-scope-arg(0)"}
!28 = distinct !{!28, !"air-alias-scopes(bm3dnr_buf::bm3dnr_buf_replicateBottom16b)"}
!29 = !{!30}
