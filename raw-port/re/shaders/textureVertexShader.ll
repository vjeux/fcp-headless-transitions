...
source_filename = "textureVertexShader"
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32"
target triple = "air64_v27-apple-macosx15.6.0"

%struct.AAPLTextureVertex = type { <2 x float>, <2 x float> }

@llvm.global_ctors = appending global [0 x { i32, void ()*, i8* }] zeroinitializer

; Function Attrs: argmemonly mustprogress nofree nosync nounwind readonly willreturn
define <{ <4 x float>, <2 x float> }> @textureVertexShader(i32 noundef %0, %struct.AAPLTextureVertex addrspace(2)* nocapture noundef readonly "air-buffer-no-alias" %1, <2 x i32> addrspace(2)* nocapture noundef readonly "air-buffer-no-alias" %2) local_unnamed_addr #0 {
  %4 = zext i32 %0 to i64
  %5 = getelementptr inbounds %struct.AAPLTextureVertex, %struct.AAPLTextureVertex addrspace(2)* %1, i64 %4, i32 0
  %6 = load <2 x float>, <2 x float> addrspace(2)* %5, align 8, !alias.scope !24, !noalias !27
  ...
  %13 = getelementptr inbounds %struct.AAPLTextureVertex, %struct.AAPLTextureVertex addrspace(2)* %1, i64 %4, i32 1
  %14 = load <2 x float>, <2 x float> addrspace(2)* %13, align 8, !tbaa !29, !alias.scope !24, !noalias !27
  %15 = insertvalue <{ <4 x float>, <2 x float> }> undef, <4 x float> %12, 0
  %16 = insertvalue <{ <4 x float>, <2 x float> }> %15, <2 x float> %14, 1
...
!15 = !{<{ <4 x float>, <2 x float> }> (i32, %struct.AAPLTextureVertex addrspace(2)*, <2 x i32> addrspace(2)*)* @textureVertexShader, !16, !19}
!16 = !{!17, !18}
!17 = !{!"air.position", !"air.arg_type_name", !"float4", !"air.arg_name", !"clipSpacePosition"}
!18 = !{!"air.vertex_output", !"generated(17textureCoordinateDv2_f)", !"air.arg_type_name", !"float2", !"air.arg_name", !"textureCoordinate"}
!19 = !{!20, !21, !23}
!20 = !{i32 0, !"air.vertex_id", !"air.arg_type_name", !"uint", !"air.arg_name", !"vertexID"}
!21 = !{i32 1, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.address_space", i32 2, !"air.struct_type_info", !22, !"air.arg_type_size", i32 16, !"air.arg_type_align_size", i32 8, !"air.arg_type_name", !"AAPLTextureVertex", !"air.arg_name", !"vertexArray"}
!22 = !{i32 0, i32 8, i32 0, !"float2", !"position", i32 8, i32 8, i32 0, !"float2", !"textureCoordinate"}
...
!26 = distinct !{!26, !"air-alias-scopes(textureVertexShader)"}
!27 = !{!28}
