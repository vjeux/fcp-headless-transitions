0x00000000023d1d -- bm3dnr_buf::bm3dnr_buf_filterImage2D3x3Plane:
source_filename = "bm3dnr_buf::bm3dnr_buf_filterImage2D3x3Plane"
...
14:                                               ; preds = %9
  ...
  %44 = tail call <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8> %43) #1
  %45 = zext i32 %39 to i64
  %46 = add nuw nsw i64 %45, %23
  %47 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %46
  %48 = load <4 x i8>, <4 x i8> addrspace(1)* %47, align 4, !tbaa !38, !alias.scope !39, !noalias !40
  %49 = tail call <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8> %48) #1
  %50 = add i32 %34, %39
  %51 = zext i32 %50 to i64
  %52 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %51
  %53 = load <4 x i8>, <4 x i8> addrspace(1)* %52, align 4, !tbaa !38, !alias.scope !39, !noalias !40
  %54 = tail call <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8> %53) #1
  ...
  %61 = tail call <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8> %60) #1
  ...
  %65 = tail call <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8> %64) #1
  ...
  %70 = tail call <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8> %69) #1
  %71 = mul i32 %38, %16
  %72 = add i32 %71, %27
  %73 = zext i32 %72 to i64
  %74 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %73
  %75 = load <4 x i8>, <4 x i8> addrspace(1)* %74, align 4, !tbaa !38, !alias.scope !39, !noalias !40
  %76 = tail call <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8> %75) #1
  %77 = zext i32 %71 to i64
  %78 = add nuw nsw i64 %77, %23
  %79 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %78
  %80 = load <4 x i8>, <4 x i8> addrspace(1)* %79, align 4, !tbaa !38, !alias.scope !39, !noalias !40
  %81 = tail call <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8> %80) #1
  %82 = add i32 %71, %34
  %83 = zext i32 %82 to i64
  %84 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %2, i64 %83
  %85 = load <4 x i8>, <4 x i8> addrspace(1)* %84, align 4, !tbaa !38, !alias.scope !39, !noalias !40
  %86 = tail call <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8> %85) #1
  ...
  %114 = tail call <4 x i32> @air.clamp.u.v4i32(<4 x i32> %113, <4 x i32> zeroinitializer, <4 x i32> <i32 255, i32 255, i32 255, i32 255>) #1
  %115 = tail call <4 x i8> @air.convert.u.v4i8.u.v4i32(<4 x i32> %114) #1
  %116 = zext i32 %18 to i64
  %117 = mul nuw i64 %116, %24
  %118 = add nuw i64 %117, %23
  %119 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %3, i64 %118
  store <4 x i8> %115, <4 x i8> addrspace(1)* %119, align 4, !tbaa !38, !alias.scope !41, !noalias !42
  br label %120
...
; Function Attrs: nounwind readnone
declare <4 x i32> @air.convert.u.v4i32.u.v4i8(<4 x i8>) local_unnamed_addr #1
...
!14 = !{void (%"struct.bm3dnr_buf::bm3dnr_buf_blend4x4Column_params" addrspace(2)*, <2 x i32>, <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*)* @"bm3dnr_buf::bm3dnr_buf_filterImage2D3x3Plane", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20, !21}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 24, !"air.arg_type_align_size", i32 4, !"air.arg_type_name", !"bm3dnr_buf::bm3dnr_buf_filterImage2D3x3Plane_params", !"air.arg_name", !"params"}
...
!22 = !{!23, !24, i64 16}
!23 = !{!"_ZTSN10bm3dnr_buf39bm3dnr_buf_filterImage2D3x3Plane_paramsE", !24, i64 0, !24, i64 4, !24, i64 8, !24, i64 12, !24, i64 16, !24, i64 20}
!24 = !{!"int", !25, i64 0}
!25 = !{!"omnipotent char", !26, i64 0}
!26 = !{!"Simple C++ TBAA"}
!27 = !{!28}
!28 = distinct !{!28, !29, !"air-alias-scope-arg(0)"}
!29 = distinct !{!29, !"air-alias-scopes(bm3dnr_buf::bm3dnr_buf_filterImage2D3x3Plane)"}
!30 = !{!31, !32}
