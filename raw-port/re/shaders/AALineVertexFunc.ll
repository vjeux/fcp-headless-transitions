0x00000000011d36 -- AALineVertexFunc:
source_filename = "AALineVertexFunc"
...
define <{ <4 x float>, <4 x float>, <2 x float> }> @AALineVertexFunc(%struct.MDPAALineUniforms addrspace(2)* nocapture noundef readonly align 16 dereferenceable(80) "air-buffer-no-alias" %0, %struct.MDPAALineVertex addrspace(1)* nocapture noundef readonly "air-buffer-no-alias" %1, i32 noundef %2) local_unnamed_addr #0 !dbg !40 {
  %4 = zext i32 %2 to i64, !dbg !43
  %5 = getelementptr inbounds %struct.MDPAALineVertex, %struct.MDPAALineVertex addrspace(1)* %1, i64 %4, i32 0, !dbg !44
  %6 = load <3 x float>, <3 x float> addrspace(1)* %5, align 16, !dbg !44, !tbaa !45, !alias.scope !48, !noalias !51
  %7 = getelementptr inbounds %struct.MDPAALineUniforms, %struct.MDPAALineUniforms addrspace(2)* %0, i64 0, i32 0, i32 0, i64 0, !dbg !53
  ...
  %11 = getelementptr inbounds %struct.MDPAALineUniforms, %struct.MDPAALineUniforms addrspace(2)* %0, i64 0, i32 0, i32 0, i64 1, !dbg !64
  ...
  %16 = getelementptr inbounds %struct.MDPAALineUniforms, %struct.MDPAALineUniforms addrspace(2)* %0, i64 0, i32 0, i32 0, i64 2, !dbg !72
  ...
  %21 = getelementptr inbounds %struct.MDPAALineUniforms, %struct.MDPAALineUniforms addrspace(2)* %0, i64 0, i32 0, i32 0, i64 3, !dbg !80
  ...
  %24 = getelementptr inbounds %struct.MDPAALineVertex, %struct.MDPAALineVertex addrspace(1)* %1, i64 %4, i32 1, !dbg !86
  %25 = load <4 x float>, <4 x float> addrspace(1)* %24, align 16, !dbg !86, !tbaa !45, !alias.scope !48, !noalias !51
  %26 = getelementptr inbounds %struct.MDPAALineVertex, %struct.MDPAALineVertex addrspace(1)* %1, i64 %4, i32 2, !dbg !87
...
!29 = !{<{ <4 x float>, <4 x float>, <2 x float> }> (%struct.MDPAALineUniforms addrspace(2)*, %struct.MDPAALineVertex addrspace(1)*, i32)* @AALineVertexFunc, !30, !34}
!30 = !{!31, !32, !33}
...
!34 = !{!35, !37, !39}
!35 = !{i32 0, !"air.buffer", !"air.buffer_size", i32 80, !"air.location_index", i32 0, i32 1, !"air.read", !"air.address_space", i32 2, !"air.struct_type_info", !36, !"air.arg_type_size", i32 80, !"air.arg_type_align_size", i32 16, !"air.arg_type_name", !"MDPAALineUniforms", !"air.arg_name", !"uniforms"}
!36 = !{i32 0, i32 64, i32 0, !"float4x4", !"mvp", i32 64, i32 8, i32 0, !"float2", !"gamma", i32 72, i32 4, i32 0, !"uint", !"stipplePattern", i32 76, i32 4, i32 0, !"float", !"stippleScale"}
!37 = !{i32 1, !"air.buffer", !"air.location_index", i32 1, i32 1, !"air.read", !"air.address_space", i32 1, !"air.struct_type_info", !38, !"air.arg_type_size", i32 48, !"air.arg_type_align_size", i32 16, !"air.arg_type_name", !"MDPAALineVertex", !"air.arg_name", !"verts"}
!38 = !{i32 0, i32 16, i32 0, !"float3", !"position", i32 16, i32 16, i32 0, !"float4", !"color", i32 32, i32 8, i32 0, !"float2", !"brushTexCoord", i32 40, i32 4, i32 0, !"float", !"stipplePos"}
!39 = !{i32 2, !"air.vertex_id", !"air.arg_type_name", !"uint", !"air.arg_name", !"vert"}
!40 = distinct !DISubprogram(name: "AALineVertexFunc", scope: !8, file: !8, line: 96, type: !41, scopeLine: 99, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !42)
!41 = !DISubroutineType(types: !42)
!42 = !{}
!43 = !DILocation(line: 101, column: 25, scope: !40)
!44 = !DILocation(line: 101, column: 37, scope: !40)
!45 = !{!46, !46, i64 0}
!46 = !{!"omnipotent char", !47, i64 0}
!47 = !{!"Simple C++ TBAA"}
!48 = !{!49}
!49 = distinct !{!49, !50, !"air-alias-scope-arg(1)"}
!50 = distinct !{!50, !"air-alias-scopes(AALineVertexFunc)"}
!51 = !{!52}
...
!60 = distinct !DILocation(line: 102, column: 33, scope: !40)
...
!86 = !DILocation(line: 103, column: 29, scope: !40)
!87 = !DILocation(line: 104, column: 37, scope: !40)
!88 = !DILocation(line: 106, column: 1, scope: !40)
