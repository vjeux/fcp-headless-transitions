0x0000000001afb0 -- textureSamplingShaderForOSCLinearizationHLG:
source_filename = "textureSamplingShaderForOSCLinearizationHLG"
...
define <4 x half> @textureSamplingShaderForOSCLinearizationHLG(<4 x float> %0, <2 x float> %1, %struct._texture_2d_t addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
12:                                               ; preds = %8, %3
  ...
  %25 = tail call fast <3 x half> @air.fmin.v3f16(<3 x half> %24, <3 x half> <half 0xH4100, half 0xH4100, half 0xH4100>) #4
  ...
  %36 = fmul fast <3 x half> %35, <half 0xH425C, half 0xH425C, half 0xH425C>
...
!15 = !{<4 x half> (<4 x float>, <2 x float>, %struct._texture_2d_t addrspace(1)*)* @textureSamplingShaderForOSCLinearizationHLG, !16, !18}
!16 = !{!17}
