0x00000000032406 -- SolidVertexFunc:
source_filename = "SolidVertexFunc"
...
%struct.MDPSolidVertex = type { <3 x float>, <4 x float> }

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define <{ <4 x float>, <4 x float> }> @SolidVertexFunc(%struct.MDPUniformMvp addrspace(2)* nocapture noundef readonly align 16 dereferenceable(64) "air-buffer-no-alias" %0, %struct.MDPSolidVertex addrspace(1)* nocapture noundef readonly "air-buffer-no-alias" %1, i32 noundef %2) local_unnamed_addr #0 !dbg !39 {
  %4 = zext i32 %2 to i64, !dbg !42
  %5 = getelementptr inbounds %struct.MDPSolidVertex, %struct.MDPSolidVertex addrspace(1)* %1, i64 %4, i32 0, !dbg !43
  %6 = load <3 x float>, <3 x float> addrspace(1)* %5, align 16, !dbg !43, !tbaa !44, !alias.scope !47, !noalias !50
  %7 = getelementptr inbounds %struct.MDPUniformMvp, %struct.MDPUniformMvp addrspace(2)* %0, i64 0, i32 0, i32 0, i64 0, !dbg !52
  ...
  %11 = getelementptr inbounds %struct.MDPUniformMvp, %struct.MDPUniformMvp addrspace(2)* %0, i64 0, i32 0, i32 0, i64 1, !dbg !63
  ...
  %16 = getelementptr inbounds %struct.MDPUniformMvp, %struct.MDPUniformMvp addrspace(2)* %0, i64 0, i32 0, i32 0, i64 2, !dbg !71
  ...
  %21 = getelementptr inbounds %struct.MDPUniformMvp, %struct.MDPUniformMvp addrspace(2)* %0, i64 0, i32 0, i32 0, i64 3, !dbg !79
  ...
  %24 = getelementptr inbounds %struct.MDPSolidVertex, %struct.MDPSolidVertex addrspace(1)* %1, i64 %4, i32 1, !dbg !85
...
!8 = !DIFile(filename: "MDPKit/Shaders/MDPSolid.metal", directory: "/Library/Caches/com.apple.xbs/Sources/MDPKit/MDPKit-45000.0.1")
...
!29 = !{<{ <4 x float>, <4 x float> }> (%struct.MDPUniformMvp addrspace(2)*, %struct.MDPSolidVertex addrspace(1)*, i32)* @SolidVertexFunc, !30, !33}
!30 = !{!31, !32}
...
!33 = !{!34, !36, !38}
!34 = !{i32 0, !"air.buffer", !"air.buffer_size", i32 64, !"air.location_index", i32 0, i32 1, !"air.read", !"air.address_space", i32 2, !"air.struct_type_info", !35, !"air.arg_type_size", i32 64, !"air.arg_type_align_size", i32 16, !"air.arg_type_name", !"MDPUniformMvp", !"air.arg_name", !"uniforms"}
!35 = !{i32 0, i32 64, i32 0, !"float4x4", !"mvp"}
!36 = !{i32 1, !"air.buffer", !"air.location_index", i32 1, i32 1, !"air.read", !"air.address_space", i32 1, !"air.struct_type_info", !37, !"air.arg_type_size", i32 32, !"air.arg_type_align_size", i32 16, !"air.arg_type_name", !"MDPSolidVertex", !"air.arg_name", !"verts"}
!37 = !{i32 0, i32 16, i32 0, !"float3", !"position", i32 16, i32 16, i32 0, !"float4", !"color"}
!38 = !{i32 2, !"air.vertex_id", !"air.arg_type_name", !"uint", !"air.arg_name", !"vert"}
!39 = distinct !DISubprogram(name: "SolidVertexFunc", scope: !8, file: !8, line: 27, type: !40, scopeLine: 30, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !41)
!40 = !DISubroutineType(types: !41)
!41 = !{}
!42 = !DILocation(line: 32, column: 25, scope: !39)
!43 = !DILocation(line: 32, column: 37, scope: !39)
!44 = !{!45, !45, i64 0}
!45 = !{!"omnipotent char", !46, i64 0}
!46 = !{!"Simple C++ TBAA"}
!47 = !{!48}
!48 = distinct !{!48, !49, !"air-alias-scope-arg(1)"}
!49 = distinct !{!49, !"air-alias-scopes(SolidVertexFunc)"}
!50 = !{!51}
...
!59 = distinct !DILocation(line: 33, column: 33, scope: !39)
...
!85 = !DILocation(line: 34, column: 29, scope: !39)
!86 = !DILocation(line: 36, column: 1, scope: !39)
