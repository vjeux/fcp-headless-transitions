0x000000000222b9 -- mcFragmentFunc:
source_filename = "mcFragmentFunc"
...
define <4 x float> @mcFragmentFunc(<4 x float> %0, <2 x float> %1, %struct._texture_2d_t addrspace(1)* nocapture readonly %2) local_unnamed_addr #0 {
...
!15 = !{<4 x float> (<4 x float>, <2 x float>, %struct._texture_2d_t addrspace(1)*)* @mcFragmentFunc, !16, !18}
!16 = !{!17}
