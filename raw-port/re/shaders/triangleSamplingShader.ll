0x000000000173f0 -- triangleSamplingShader:
source_filename = "triangleSamplingShader"
...
define <4 x float> @triangleSamplingShader(<4 x float> %0, <4 x float> returned %1) local_unnamed_addr #0 {
  ret <4 x float> %1
}
...
!15 = !{<4 x float> (<4 x float>, <4 x float>)* @triangleSamplingShader, !16, !18}
!16 = !{!17}
