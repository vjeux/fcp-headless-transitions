0x0000000002a766 -- MDPTextureAlphaHitIDVertexFunc:
source_filename = "MDPTextureAlphaHitIDVertexFunc"
...
%struct.MDPTextureAlphaHitIDVertex = type { <3 x float>, <2 x float>, i32 }

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define <{ <4 x float>, <2 x float>, i32 }> @MDPTextureAlphaHitIDVertexFunc(%struct.MDPUniformMvp addrspace(2)* nocapture noundef readonly align 16 dereferenceable(64) "air-buffer-no-alias" %0, %struct.MDPTextureAlphaHitIDVertex addrspace(1)* nocapture noundef readonly "air-buffer-no-alias" %1, i32 noundef %2) local_unnamed_addr #0 !dbg !40 {
  %4 = zext i32 %2 to i64, !dbg !43
  %5 = getelementptr inbounds %struct.MDPTextureAlphaHitIDVertex, %struct.MDPTextureAlphaHitIDVertex addrspace(1)* %1, i64 %4, i32 0, !dbg !44
  ...
  %24 = getelementptr inbounds %struct.MDPTextureAlphaHitIDVertex, %struct.MDPTextureAlphaHitIDVertex addrspace(1)* %1, i64 %4, i32 1, !dbg !86
  %25 = load <2 x float>, <2 x float> addrspace(1)* %24, align 16, !dbg !86, !tbaa !45, !alias.scope !48, !noalias !51
  %26 = getelementptr inbounds %struct.MDPTextureAlphaHitIDVertex, %struct.MDPTextureAlphaHitIDVertex addrspace(1)* %1, i64 %4, i32 2, !dbg !87
  %27 = load i32, i32 addrspace(1)* %26, align 8, !dbg !87, !tbaa !88, !alias.scope !48, !noalias !51
  %28 = insertvalue <{ <4 x float>, <2 x float>, i32 }> undef, <4 x float> %23, 0, !dbg !91
  %29 = insertvalue <{ <4 x float>, <2 x float>, i32 }> %28, <2 x float> %25, 1, !dbg !91
  %30 = insertvalue <{ <4 x float>, <2 x float>, i32 }> %29, i32 %27, 2, !dbg !91
  ret <{ <4 x float>, <2 x float>, i32 }> %30, !dbg !91
}
...
!29 = !{<{ <4 x float>, <2 x float>, i32 }> (%struct.MDPUniformMvp addrspace(2)*, %struct.MDPTextureAlphaHitIDVertex addrspace(1)*, i32)* @MDPTextureAlphaHitIDVertexFunc, !30, !34}
!30 = !{!31, !32, !33}
!31 = !{!"air.position", !"air.arg_type_name", !"float4", !"air.arg_name", !"position"}
!32 = !{!"air.vertex_output", !"generated(8texCoordDv2_f)", !"air.arg_type_name", !"float2", !"air.arg_name", !"texCoord"}
!33 = !{!"air.vertex_output", !"generated(5hitIDj)", !"air.arg_type_name", !"uint", !"air.arg_name", !"hitID"}
!34 = !{!35, !37, !39}
...
!37 = !{i32 1, !"air.buffer", !"air.location_index", i32 1, i32 1, !"air.read", !"air.address_space", i32 1, !"air.struct_type_info", !38, !"air.arg_type_size", i32 32, !"air.arg_type_align_size", i32 16, !"air.arg_type_name", !"MDPTextureAlphaHitIDVertex", !"air.arg_name", !"verts"}
!38 = !{i32 0, i32 16, i32 0, !"float3", !"position", i32 16, i32 8, i32 0, !"float2", !"texCoord", i32 24, i32 4, i32 0, !"uint", !"hitID"}
!39 = !{i32 2, !"air.vertex_id", !"air.arg_type_name", !"uint", !"air.arg_name", !"vert"}
!40 = distinct !DISubprogram(name: "MDPTextureAlphaHitIDVertexFunc", scope: !8, file: !8, line: 28, type: !41, scopeLine: 31, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !42)
...
!50 = distinct !{!50, !"air-alias-scopes(MDPTextureAlphaHitIDVertexFunc)"}
!51 = !{!52}
...
!86 = !DILocation(line: 35, column: 32, scope: !40)
!87 = !DILocation(line: 36, column: 29, scope: !40)
!88 = !{!89, !90, i64 24}
!89 = !{!"_ZTS26MDPTextureAlphaHitIDVertex", !46, i64 0, !46, i64 16, !90, i64 24}
!90 = !{!"int", !46, i64 0}
!91 = !DILocation(line: 38, column: 1, scope: !40)
