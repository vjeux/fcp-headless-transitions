0x0000000009cc0d -- soGuidedFilter::soGuidedFilter_I1p3_Pass4_a_b_mean_out:
source_filename = "soGuidedFilter::soGuidedFilter_I1p3_Pass4_a_b_mean_out"
...
58:                                               ; preds = %58, %36
  %59 = phi <2 x float> [ %31, %36 ], [ %81, %58 ]
  %60 = phi <2 x float> [ %24, %36 ], [ %84, %58 ]
  %61 = phi <2 x i32> [ %11, %36 ], [ %87, %58 ]
  %62 = phi i32 [ 0, %36 ], [ %88, %58 ]
  %63 = phi <4 x float> [ %30, %36 ], [ %75, %58 ]
  %64 = phi <4 x float> [ %29, %36 ], [ %78, %58 ]
  %65 = fdiv <4 x float> %63, %41
  tail call void @air.write_texture_2d.v4f32(%struct._texture_2d_t addrspace(1)* nocapture %5, <2 x i32> %61, <4 x float> %65, i32 0, i32 2) #2, !alias.scope !39, !noalias !40
  %66 = fdiv <4 x float> %64, %41
  tail call void @air.write_texture_2d.v4f32(%struct._texture_2d_t addrspace(1)* nocapture %6, <2 x i32> %61, <4 x float> %66, i32 0, i32 2) #2, !alias.scope !39, !noalias !40
  %67 = tail call { <4 x float>, i8 } @air.sample_texture_2d.v4f32(%struct._texture_2d_t addrspace(1)* nocapture readonly %3, %struct._sampler_t addrspace(2)* nocapture readonly %2, <2 x float> %59, i1 true, <2 x i32> zeroinitializer, i1 false, float 0.000000e+00, float 0.000000e+00, i32 0) #1, !alias.scope !28, !noalias !25
  %68 = extractvalue { <4 x float>, i8 } %67, 0
  %69 = fadd <4 x float> %63, %68
  %70 = tail call { <4 x float>, i8 } @air.sample_texture_2d.v4f32(%struct._texture_2d_t addrspace(1)* nocapture readonly %4, %struct._sampler_t addrspace(2)* nocapture readonly %2, <2 x float> %59, i1 true, <2 x i32> zeroinitializer, i1 false, float 0.000000e+00, float 0.000000e+00, i32 0) #1, !alias.scope !28, !noalias !25
  %71 = extractvalue { <4 x float>, i8 } %70, 0
  %72 = fadd <4 x float> %64, %71
  %73 = tail call { <4 x float>, i8 } @air.sample_texture_2d.v4f32(%struct._texture_2d_t addrspace(1)* nocapture readonly %3, %struct._sampler_t addrspace(2)* nocapture readonly %2, <2 x float> %60, i1 true, <2 x i32> zeroinitializer, i1 false, float 0.000000e+00, float 0.000000e+00, i32 0) #1, !alias.scope !28, !noalias !25
  %74 = extractvalue { <4 x float>, i8 } %73, 0
  %75 = fsub <4 x float> %69, %74
  %76 = tail call { <4 x float>, i8 } @air.sample_texture_2d.v4f32(%struct._texture_2d_t addrspace(1)* nocapture readonly %4, %struct._sampler_t addrspace(2)* nocapture readonly %2, <2 x float> %60, i1 true, <2 x i32> zeroinitializer, i1 false, float 0.000000e+00, float 0.000000e+00, i32 0) #1, !alias.scope !28, !noalias !25
  %77 = extractvalue { <4 x float>, i8 } %76, 0
  %78 = fsub <4 x float> %72, %77
  %79 = extractelement <2 x float> %59, i64 1
  %80 = fadd float %79, 1.000000e+00
  %81 = insertelement <2 x float> %59, float %80, i64 1
  %82 = extractelement <2 x float> %60, i64 1
  %83 = fadd float %82, 1.000000e+00
  %84 = insertelement <2 x float> %60, float %83, i64 1
  %85 = extractelement <2 x i32> %61, i64 1
  %86 = add i32 %85, 1
  %87 = insertelement <2 x i32> %61, i32 %86, i64 1
  %88 = add nuw nsw i32 %62, 1
  %89 = icmp eq i32 %88, %34
  br i1 %89, label %90, label %58, !llvm.loop !41
...
!14 = !{void (%"struct.soGuidedFilter::soGuidedFilter_I1p1_Pass4_params" addrspace(2)*, <2 x i32>, %struct._sampler_t addrspace(2)*, %struct._texture_2d_t addrspace(1)*, %struct._texture_2d_t addrspace(1)*, %struct._texture_2d_t addrspace(1)*, %struct._texture_2d_t addrspace(1)*)* @"soGuidedFilter::soGuidedFilter_I1p3_Pass4_a_b_mean_out", !15, !16}
!15 = !{}
!16 = !{!17, !19, !20, !21, !22, !23, !24}
!17 = !{i32 0, !"air.buffer", !"air.location_index", i32 0, i32 1, !"air.read", !"air.struct_type_info", !18, !"air.arg_type_size", i32 32, !"air.arg_type_align_size", i32 16, !"air.arg_type_name", !"soGuidedFilter::soGuidedFilter_I1p3_Pass4_a_b_mean_out_params", !"air.arg_name", !"params"}
...
!23 = !{i32 5, !"air.texture", !"air.location_index", i32 2, i32 1, !"air.write", !"air.arg_type_name", !"texture2d<float, write>", !"air.arg_name", !"output_a_mean"}
!24 = !{i32 6, !"air.texture", !"air.location_index", i32 3, i32 1, !"air.write", !"air.arg_type_name", !"texture2d<float, write>", !"air.arg_name", !"output_b_mean"}
!25 = !{!26}
!26 = distinct !{!26, !27, !"air-alias-scope-arg(0)"}
!27 = distinct !{!27, !"air-alias-scopes(soGuidedFilter::soGuidedFilter_I1p3_Pass4_a_b_mean_out)"}
!28 = !{!29, !30}
!29 = distinct !{!29, !27, !"air-alias-scope-samplers"}
!30 = distinct !{!30, !27, !"air-alias-scope-textures"}
!31 = !{!32, !35, i64 16}
!32 = !{!"_ZTSN14soGuidedFilter45soGuidedFilter_I1p3_Pass4_a_b_mean_out_paramsE", !33, i64 0, !35, i64 16, !35, i64 20}
