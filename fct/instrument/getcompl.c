...
static FILE* g=NULL;
static void L(const char*f,...){ if(!g)g=fopen("/tmp/getcompl_trace.txt","a"); va_list a; va_start(a,f); vfprintf(g,f,a); va_end(a); fflush(g);}
// double getCompletion(this x0, CMTime& x1, double index d0) -> completion d0
