...
hook=ctypes.CDLL(REPO+"/fct/instrument/emit_idx.dylib"); hook.setup_emit_idx.restype=ctypes.c_int
print("setup", hook.setup_emit_idx(), flush=True)
doc=ozengine.load_doc(REPO+"/fct/minimized/Objects__Squares/case.motr")
ozengine.render_frame(doc,C.IMG_A,C.IMG_B,0.25*2.333,"/tmp/ei.png")
print("done",flush=True); open("/tmp/ei_done.txt","w").write("done")
