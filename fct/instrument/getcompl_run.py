...
hook=ctypes.CDLL(REPO+"/fct/instrument/getcompl.dylib"); hook.setup_getcompl.restype=ctypes.c_int
print("setup", hook.setup_getcompl(), flush=True)
doc=ozengine.load_doc(REPO+"/fct/minimized/Objects__Squares/case.motr")
# render at frac 0.3 (where scramble is clearest)
ozengine.render_frame(doc,C.IMG_A,C.IMG_B,0.3*2.333,"/tmp/gc.png")
