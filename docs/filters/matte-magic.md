...
(parm N = the getter's fromParm: index; slot K = the primitive/shader
 SetParameter index that feeds hg_Params[K]):
  ...
  SetParameter slots (source decoded by stack/register dataflow):
    slot 0  <-  parm1 (float), parm2 (float), parm3 (float)
    slot 0  <-  (constant / computed)
    slot 58  <-  (constant / computed)
    slot 59  <-  (constant / computed)
    slot 60  <-  (constant / computed)
    slot 61  <-  (constant / computed)
    slot 62  <-  (constant / computed)
    slot 59  <-  (constant / computed)
    slot 60  <-  (constant / computed)
    slot 61  <-  (constant / computed)
    slot 62  <-  (constant / computed)
    slot 0  <-  parm2 (float), parm1 (float)
```
